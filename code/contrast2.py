...
try:
    ...
    while True:
        ...
        target_field = field.TargetField(targetx, targety, 1)
        ...
        path = []
        path.append(Node(carx, cary, carvx, carvy))
    ...
    animator = ani.FuncAnimation(fig, basis, interval=5)
    plt.show()
